        ...
        <div className="hero-head">
          <nav id="navbar" className="navbar is-fixed-top is-transparent">
            ...
            <div className="container">
              ...
              <Link className="navbar-item is-hidden-desktop" to="/mobile/menu" > 菜单</Link>
              </div>
                ...
                <div >
                  <aside className="menu">
                    ...
                    <ul className="menu-list">
                      ...
                      <li><Link to="/page/about" replace>关于</Link></li>
                      <li><Link to="/archives" replace>归档</Link></li>
                      <li><Link to="/page/Link" replace>友情链接</Link></li>
                      <li><Link to="/project" replace>项目列表</Link></li>
                    </ul>
      ...
      return(
        <div className="column">
          ...
          <div>
            ...
            <br/>
            <a href="https://travis-ci.org/YuYanDev/yuyandev.github.io/builds"><img src="https://travis-ci.org/YuYanDev/yuyandev.github.io.svg?branch=source" alt="svg"/></a>
          </div>
            ...
            <div className="media-content">
              <div className="content">                              
                ...
                <p>
                  ...
                  <br/>
                  <small>仔细检查一下</small><strong> -OR- </strong><small>去Github上反馈bugs</small>
                  <br/>
                  <small><Link to="/">返回首页</Link></small>
                </p>
              </div>
            </div>
          </article>                     
          ...
          <div className="columns">
            <div className="column is-three-quarters">   
                        ...
                        <article className="media">
                          ...
                          <div className="media-content">
                            <div className="content">                              
                              ...
                              <p>
                                <small>{items.excerpt.substring(0,300)}... </small>
                                <br/>
              ...
              <nav className="pagination is-centered" role="navigation" aria-label="pagination">
                {this.state.articleIdLast?<Link className="pagination-previous" to={{pathname:'/article/'+this.state.articleIdLast}} onClick={this.componentWillMount()}>上一页</Link>:<a className="pagination-previous " disabled>没有了</a>}
                {/* <Link className="pagination-previous" to="/article/1"  >第一页</Link> */}
                {this.state.articleIdNext?<Link className="pagination-next"  to={{pathname:'/article/'+this.state.articleIdNext}} onClick={this.componentWillMount()}>下一页</Link>:<a className="pagination-next " disabled>没有了</a>}
            ...
            <div className="column is-three-quarters">   
              ...
              <nav className="pagination is-centered" role="navigation" aria-label="pagination">
                ...
                <ul className="pagination-list">
                  ...
                  <li><a className="pagination-link is-current" aria-label="Page 46" aria-current="page">1</a></li>
            ...
            <div className="columns">
              <div className="column is-three-quarters"> 
                <div >
                  ...
                  { Object.entries(this.state.ProjectApiBack).map(function(item,index){
                    var items = JSON.parse(JSON.stringify(item.slice(1)).substring(1,JSON.stringify(item.slice(1)).length-1));
                    return(
                      <div key={items.id}>
                        <article className="media">
                          ...
                          <div className="media-content">
                            <div className="content">
                              <p>
                                <a href={items.html_url}><strong>{items.name}</strong></a>  <small>{items.fork?<i className="fa fa-code-fork" aria-hidden="true"></i>:''}</small>
                                <br/>
